    ...
    <form onSubmit={handleSubmit} className="space-y-8 pb-10">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        ...
        <div className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">Contexto do Squad</label>
            <textarea 
              name="contexto_squad" 
              defaultValue={initialConfig.contexto_squad} 
              className="w-full h-24 text-sm font-mono bg-slate-50 border border-slate-300 rounded-lg p-3 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 resize-y"
            />
            <p className="mt-1 text-xs text-slate-500">Ex: Lembrete para o Squad... O público alvo... Proibição de cliques de marketing.</p>
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">Tom de Voz Global</label>
            <textarea 
              name="tom_de_voz_global" 
              defaultValue={initialConfig.tom_de_voz_global} 
              className="w-full h-20 text-sm font-mono bg-slate-50 border border-slate-300 rounded-lg p-3 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 resize-y"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        ...
        <div className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">Regras para Notícias (Quente)</label>
            <textarea 
              name="prompt_noticias" 
              defaultValue={initialConfig.agente_1.prompt_noticias} 
              className="w-full h-40 text-sm font-mono bg-slate-50 border border-slate-300 rounded-lg p-3 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 resize-y"
            />
            <p className="mt-1 text-xs text-slate-500">Esta regra é combinada com o uso do Google Search automático da API no lote ímpar.</p>
          </div>

          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-2">Regras para Temas Perenes</label>
            <textarea 
              name="prompt_perene" 
              defaultValue={initialConfig.agente_1.prompt_perene} 
              className="w-full h-40 text-sm font-mono bg-slate-50 border border-slate-300 rounded-lg p-3 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 resize-y"
            />
            <p className="mt-1 text-xs text-slate-500">Comportamentos e dores recorrentes (lote par).</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        ...
        <div>
          ...
          <textarea 
            ...
            className="w-full h-80 text-sm font-mono bg-slate-50 border border-slate-300 rounded-lg p-3 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 resize-y"
          />
