            ...
            {settings.map((s, index) => (
                <div key={s.id} className={'bg-white dark:bg-surface-dark border ' + (s.nicheKey === 'GLOBAL_IMAGE' ? 'border-primary shadow-md' : 'border-slate-200 dark:border-border-dark') + ' rounded-xl p-6 relative'}>
                    ...
                    <textarea
                        ...
                        className="w-full bg-slate-50 dark:bg-surface-darker border border-slate-200 dark:border-border-dark rounded-lg p-4 text-sm text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-primary outline-none resize-none h-32"
                    />
